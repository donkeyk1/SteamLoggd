  ...
  return (
    <div className="flex flex-col gap-2">
      <div className="flex items-center gap-2">
        ...
        >
          <SyncIcon size={13} /> {running ? "Syncing…" : "Sync Steam"}
        </button>

        {result && (
          <span className="hf-mono" style={{ fontSize: 11, color: "var(--hf-emerald)" }}>
            {result.synced} games · {result.igdbEnriched} enriched
      ...
      {result && result.dropped.length > 0 && !droppedDismissed && (
        ...
        >
          ...
          <p style={{ fontSize: 12, color: "var(--hf-fg-muted)", margin: 0, lineHeight: 1.5 }}>
            These are likely demos, betas, DLC, or soundtracks that Steam counts as games but IGDB doesn&apos;t:
          </p>
