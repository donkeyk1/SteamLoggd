  ...
  return (
    ...
    >
      <div className="flex flex-col items-center gap-8 animate-fade" style={{ maxWidth: 440, width: "100%", padding: "0 24px" }}>
        ...
        {error === "AccessDenied" && (
          <p style={{ fontSize: 13, color: "var(--hf-rose)", textAlign: "center" }}>
            Sign-in refused. If you used Discord, verify your email there first.
          </p>
        )}

        <Link href="/" style={{ fontSize: 13, color: "var(--hf-fg-dim)", display: "inline-flex", alignItems: "center", gap: 4, textDecoration: "none" }}>
          ← Back to home
        </Link>
      </div>
    </main>
